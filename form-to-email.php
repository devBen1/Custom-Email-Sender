...
$enable_auto_response = true;//Make this false if you dont want auto-response.

//auto-response to the user
$auto_response_subj = "$head";
$auto_response = $msg;


$email_from = ''; /*From address for the emails*/
$thank_you_url = 'contact.php';/*URL to redirect to, after successful form submission*/
